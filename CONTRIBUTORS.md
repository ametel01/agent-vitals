...
- **[@mvanhorn](https://github.com/mvanhorn)** — The [last30days-skill](https://github.com/mvanhorn/last30days-skill) project provided the structural template: SKILL.md for skill definitions, SPEC.md for specifications, install scripts, and the overall approach to packaging Claude Code skills.
